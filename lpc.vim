...
" modif. "c.vim", Adrian Holzwarth (adrian@cl-ki.uni-osnabrueck.de)
" efuns/lfuns updated for LD, Christian Brunsch (chagall@benares.de)
" Last change:	Son Oct 29 15:42 MET DST 2006
...
syn region lpcPreProc		start="^\s*#\s*pragma \(strong_types\|strict_types\|combine_strings\|verbose_errors\|save_types\|no_combine_strings\|no_clone\|no_shadow\|no_inherit\|warn_deprecated\|range_check\|pedantic\|weak_types\|rtt_checks\|no_rtt_checks\|slppy\|no_range_check\|no_warn_deprecated\|warn_empty_casts\|no_warn_empty_casts\|warn_missing_return\|no_warn_missing_return\|warn_function_inconsistent\|no_warn_function_inconsistent\)\>" skip="\\$" end="$" contains=ALLBUT,lpcPreCondit,lpcInclude,lpcDefine,lpcInParen,lpcPreProc

" Highlight User Labels<D-7>
